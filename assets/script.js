...
var checkTimes = 1 
var viewHighScoresButtonEl = document.getElementById('view-high-scores'); 
var startQuizButtonEl = document.getElementById('start-quiz'); 
var answer1ButtonEl = document.getElementById('answer1'); 
var answer2ButtonEl = document.getElementById('answer2'); 
var answer3ButtonEl = document.getElementById('answer3'); 
var answer4ButtonEl = document.getElementById('answer4'); 
    ...
    var timeInterval = setInterval(function() {
        ...
        if(timeLeft >= 1 && finalAnswerCheck !== 1) {
            ...
            answer2ButtonEl.addEventListener("click", function() {
                ...
                if (questionDisplay.textContent === "Strings must be enclosed with:" && answer2ButtonEl.textContent === "Curly brackets") {
                    console.log("Correct");
                    answerCorrectWrong.style.display=""; 
                    answerCorrectWrong.textContent = "Correct!";
                    answerCorrectWrong.style.borderTop = "solid #800080";
          ...
          questionNumber = 0; 
          answerNumber = 0; 
          answer1Btuttonl.style.display = 'none';
          answer2ButtonEl.style.display = 'none';
          answer3ButtonEl.style.display = 'none';
          answer4ButtonEl.style.display = 'none';
          answerCorrectWrong.style.display='none'; 
